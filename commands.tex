...
\settextfont[Scale=1]{HM FLotoos}
...
\setdigitfont[Scale=1]{HM FLotoos}%{Persian Modern}
%%%%%%%%%%%%%%%%%%%%%%%%%%
% تعریف قلم‌های فارسی و انگلیسی اضافی برای استفاده در بعضی از قسمت‌های متن
\defpersianfont\titlefont[Scale=1]{HM FLotoos}
...
%%مخفی کردن لیست اشکال و لیست جدول‌ها از فهرست
